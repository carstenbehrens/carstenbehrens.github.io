<template>
  <div
    ...
    :class="theme"
  >
    <header class="top-0 left-0 z-40 fixed w-full border-t-14 border-blue-800">
      <nav class="container mx-auto flex flex-col sm:flex-row py-8 justify-end">
        <div class="block lg:hidden self-end sm:self-auto">
          <button
            @click="toggle"
